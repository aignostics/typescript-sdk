...
export interface PlatformSDK {
  ...
  getApplicationVersionDetails(applicationId: string, version: string): Promise<VersionReadResponse>;
  
  // Application Execution
  createApplicationRun(request: RunCreationRequest): Promise<RunCreationResponse>;
  
  // Run Management
  listApplicationRuns(options?: { applicationId?: string; applicationVersion?: string }): Promise<RunReadResponse[]>;
