...
describe('CLI Integration Tests', () => {
  ...
  describe('applications list command', () => {
    it('should list applications successfully', async () => {
      ...
      expect(consoleSpy.log).toHaveBeenCalledWith(expect.stringContaining('application_id'));
      expect(consoleSpy.log).toHaveBeenCalledWith(expect.stringContaining('name'));
    });
  });
  ...
  describe('applications versions get command', () => {
    it('should get application version details successfully', async () => {
      ...
      expect(consoleSpy.log).toHaveBeenCalledWith(expect.stringContaining(version.number));
    });
  ...
  describe('runs list command', () => {
    it('should list application runs successfully', async () => {
      ...
      expect(consoleSpy.log).toHaveBeenCalledWith(expect.stringContaining('run_id'));
      expect(consoleSpy.log).toHaveBeenCalledWith(expect.stringContaining('state'));
    });
  ...
  describe('runs results list command', () => {
    it('should list run results successfully', async () => {
      ...
      expect(consoleSpy.log).toHaveBeenCalledWith(expect.stringContaining('item_id'));
  ...
  describe('runs list with options', () => {
    ...
    it('should support sort option', async () => {
      process.argv = ['node', 'cli.js', 'runs', 'list', '--sort', '["run_id"]', '--format', 'json'];
  ...
  describe('runs create with items', () => {
    ...
    it('should create application run with items piped via stdin', async () => {
      ...
      process.argv = ['node', 'cli.js', 'runs', 'create', 'test-app', 'v1.0.0', '--format', 'json'];
  ...
  describe('grants create command', () => {
    it('should create a grant successfully', async () => {
      ...
      expect(consoleSpy.log).toHaveBeenCalledWith(expect.stringContaining('grant_id'));
    });
  ...
  describe('grants get command', () => {
    it('should get grant details successfully', async () => {
      process.argv = ['node', 'cli.js', 'grants', 'get', 'grant-1', '--format', 'json'];
  ...
  describe('grants revoke command', () => {
    it('should revoke a grant successfully', async () => {
      process.argv = ['node', 'cli.js', 'grants', 'revoke', 'grant-1', '--format', 'json'];
  ...
  describe('share-tokens create command', () => {
    it('should create a share token successfully', async () => {
      ...
      expect(consoleSpy.log).toHaveBeenCalledWith(expect.stringContaining('share_token'));
      expect(consoleSpy.error).toHaveBeenCalledWith(
  ...
  describe('share-tokens list command', () => {
    it('should list share tokens successfully', async () => {
      ...
      expect(consoleSpy.log).toHaveBeenCalledWith(expect.stringContaining('share_token_id'));
    });
  ...
  describe('share-tokens get command', () => {
    it('should get share token details successfully', async () => {
      process.argv = ['node', 'cli.js', 'share-tokens', 'get', 'share-token-1', '--format', 'json'];
