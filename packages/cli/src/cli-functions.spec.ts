...
describe('CLI Functions Unit Tests', () => {
  ...
  describe('handleInfo', () => {
    it('should display SDK information', () => {
      ...
      vi.mocked(fs.readFileSync).mockReturnValueOnce(JSON.stringify({ version: mockVersion }));
  ...
  describe('getApplicationDetails', () => {
    it('should return application details', async () => {
      ...
      const result = await getApplicationDetails('production', mockAuthService, 'app1');
  ...
  describe('listApplicationVersions', () => {
    it('should return the application versions', async () => {
      ...
      const result = await listApplicationVersions('production', mockAuthService, 'app1');
  ...
  describe('listRunResults', () => {
    it('should return the run results', async () => {
      ...
      const result = await listRunResults('production', mockAuthService, 'run-1');
  ...
  describe('revokeGrant', () => {
    it('should revoke a grant successfully', async () => {
      ...
      const result = await revokeGrant('production', mockAuthService, 'grant-1');
  ...
  describe('getShareToken', () => {
    it('should get share token details successfully', async () => {
      ...
      const result = await getShareToken('production', mockAuthService, 'share-token-1');
  ...
  describe('revokeShareToken', () => {
    it('should revoke a share token successfully', async () => {
      ...
      const result = await revokeShareToken('production', mockAuthService, 'share-token-1');
